...
import com.zhourx.mapper.ConfigMapper;
import com.zhourx.model.domain.Config;
import com.zhourx.service.ConfigService;
import com.zhourx.service.FileService;
import com.zhourx.utils.FileUtils;
import com.zhourx.utils.SuperProperties;
...
public class ConfigServiceImpl extends ServiceImpl<ConfigMapper, Config>
    ...
    public void uploadImages(MultipartFile file) {
        ...
        // } else {
            ...
            String filePath = fileService.uploadFileAvatarToMinio(file);
