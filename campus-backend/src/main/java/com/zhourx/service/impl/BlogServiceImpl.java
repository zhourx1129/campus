...
import com.zhourx.mapper.BlogMapper;
import com.zhourx.model.domain.*;
import com.zhourx.model.enums.MessageTypeEnum;
        ...
        try {
            ...
            if (images != null) {
                for (MultipartFile image : images) {
                    ...
                    String filename = fileService.uploadFileAvatarToMinio(image);
