...
import static com.zhourx.constants.RedisConstants.*;
import static com.zhourx.constants.SystemConstants.*;
import static com.zhourx.constants.UserConstants.*;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    private static final String SALT = "zhourx";
    ...
    @Override
    public long userRegister(String phone,String email, String userAccount, String userPassword, String checkPassword) {
        // 1. 校验
        if (StringUtils.isAnyBlank(phone,email, userAccount, userPassword, checkPassword)) {
